...
`;
    ...
    return () => {
      ...
      type MeshWithRemove = Mesh & { remove?: () => void };
      callIfFn(meshRef.current as MeshWithRemove, 'remove');
      type RendererWithDestroy = Renderer & { destroy?: () => void };
      callIfFn(rendererRef.current as RendererWithDestroy, 'destroy');
