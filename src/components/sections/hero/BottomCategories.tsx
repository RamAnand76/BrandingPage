...
export const BottomCategories = () => {
  ...
  return (
    <motion.div
      className="flex flex-col items-start md:flex-row md:items-center gap-2 md:gap-6 text-[15px] md:text-[17px] tracking-[0.05em] font-medium text-white uppercase mt-12 md:mt-auto pt-0 md:pt-48 md:-ml-8 md:-mb-8 z-30"
